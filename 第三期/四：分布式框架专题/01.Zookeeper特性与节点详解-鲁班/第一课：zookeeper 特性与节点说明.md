...
![image-20210605001647327](https://gitee.com/black-warrior/image/raw/master/image/image-20210605001647327.png)

zookeeper 中数据基本单元叫节点，节点之下可包含子节点，最后以树级方式程现。每个节点拥有唯一的路径path。客户端基于PATH上传节点数据，zookeeper 收到后会实时通知对该路径进行监听的客户端。

![image-20210605001743053](https://gitee.com/black-warrior/image/raw/master/image/image-20210605001743053.png)
...
语法： 
	...
	1. addauth digest <用户名>:<密码>
 	2. setAcl <path> auth:<用户名>:<权限位>
